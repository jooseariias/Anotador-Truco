...
export default function ListPlayers() {
  ...
  return (
    <div>
     ...
     <div > {Object.keys(players).length > 0 ? (
        <ul >
          {Object.keys(players).map((playerId) => {
            ...
            return (
              ...
              >
                ...
                <div>
                  <button
                    className="bg-green-500 hover:bg-green-700 w-10 rounded-md h-10"
                ...
                <div>
                  <button
                    className="bg-blue-300 hover:bg-blue-500 w-10 rounded-md h-10"
                    onClick={() => updatePoints(playerId, -1)}
                  >
                    -
                  </button>
                ...
                <div>
                  {" "}
                  <button
                    className="bg-red-500 hover:bg-red-700 w-10 h-10 rounded-[50px]"
        ...
        <p className=" font-bold text-center text-[20px] underline">No hay jugadores en la lista.</p>
      )}</div>
    </div>
  );
}
